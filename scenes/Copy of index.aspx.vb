...
Partial Class _Scenes
    ...
    Public Sub BindData()
        ...
        objConn.Open()
        Dim strSQL As String = "SELECT [LocationPlaceName],[LocationPlaceID], [SceneID], [SceneImagePath], [Title], [TitleAndYear],[LocationPlaceAndSiteName], [LocationAliasCountryAndPlace], [Notes] FROM qryTitlesAndScenes  WHERE [SceneID] = " & intSceneID
