...
Partial Class _Comments
    ...
    Sub AddComment(ByVal Sender As Object, ByVal e As EventArgs)
        ...
        If Page.IsValid Then
            ...
            If email.Text = String.Empty Then
                ...
                Dim strConn As String = ConfigurationManager.ConnectionStrings("CommentsConnectionString").ConnectionString
                Dim objConn As New OleDbConnection(strConn)
                strIPAddress = Request.ServerVariables("REMOTE_ADDR")

                strSQL = "INSERT INTO tblComments2 (IPAddress,UserName,UserEmail,Comments,CommentDate) " & _
                ...
                dbComm.Parameters.Add("@IpAddress", OleDbType.VarWChar).Value = strIPAddress
                dbComm.Parameters.Add("@UserName", OleDbType.VarWChar).Value = txtUserName.Text
                dbComm.Parameters.Add("@UserEmail", OleDbType.VarWChar).Value = txtUserEmail.Text
                dbComm.Parameters.Add("@Comments", OleDbType.LongVarWChar).Value = txtComments.Text
                dbComm.Parameters.Add("@CommentDate", OleDbType.Date).Value = strDate
    ...
    Private Sub BindDataGrid()
        ...
        strSQL = "SELECT UserName, UserEmail, Comments, CommentDate FROM qryComments2 WHERE " & strCriteria
